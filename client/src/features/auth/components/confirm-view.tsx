      ...
      <div className='mx-auto flex w-full max-w-lg flex-col justify-center'>
        <div className='flex w-full flex-col items-center justify-center py-20'>
          {confirmedSuccessfully == null && (
            <>
              <div className='bg-gradient-to-b from-foreground to-transparent bg-clip-text text-xs font-extrabold text-transparent'>
                {`
 ⠀⠀⠀⠀⠀⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡏⠉⠉⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
 ⠀⠀⠀⠀⠀⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡅⠰⡁⢨⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
 ⠀⠀⠀⠀⠀⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠋⠉⠙⠻⣿⣿⣿⡆⠠⠁⢠⣿⣿⣿⠟⠋⠉⠙⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
...
`}
          ...
          {confirmedSuccessfully != null && confirmedSuccessfully && (
            <>
              <pre className='bg-gradient-to-b from-foreground to-transparent bg-clip-text text-xs font-extrabold text-transparent'>
                {`
...
`}
          ...
          {confirmedSuccessfully != null && !confirmedSuccessfully && (
            <>
              <div className='bg-gradient-to-b from-foreground to-transparent bg-clip-text font-extrabold text-transparent'>
                {`
    ⡴⠒⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣼⠉⠳⡆⠀
    ⣇⠰⠉⢙⡄⠀⠀⣴⠖⢦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⣆⠁⠙⡆
    ⠘⡇⢠⠞⠉⠙⣾⠃⢀⡼⠀⠀⠀⠀⠀⠀⠀⢀⣼⡀⠄⢷⣄⣀⠀⠀⠀⠀⠀⠀⠀⠰⠒⠲⡄⠀⣏⣆⣀⡍
    ...
    ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠲⢤⣀⣀⠀⢀⣀⣀⠤⠒⠉⠀⠀⠀⠀
              ...
              <h1 className='mb-4 text-xl font-bold'>
                Ошибка подтверждения. {token ? 'Попробуйте еще раз.' : 'Неверная ссылка.'}
              </h1>
            </>
          )}
