...
function PrivacyMail() {
  return (
    <a
      ...
      href='mailto:privacy@mfl.maxbarsukov.ru'
    >
      privacy@mfl.maxbarsukov.ru
    </a>
  );
}
      ...
      <div className='mx-auto flex w-full max-w-5xl flex-col justify-center'>
        <div className='py-10'>
          ...
          <div className='my-2'>
            ...
            <a
              className='text-blue-600 hover:underline dark:text-blue-500'
              href='https://www.mos.ru/madi/documents/akty-federalnogo-zakonodatelstva/view/243898220/'
            >
            ...
            <span className='font-bold'>MyFilmList</span> (далее — Оператор).
            <ul className='py-2'>
              ...
              <li className='px-4'>
                ...
                посетителях веб-сайта <LinkToSite />.
              </li>
            </ul>
          </div>
          ...
          <div className='my-2'>
            ...
            <ul>
              ...
              <li className='mb-2 px-4'>
                ...
                определенному или определяемому Пользователю веб-сайта <LinkToSite />.
              </li>
              <li className='mb-2 px-4'>
          ...
          <div className='my-2'>
            ...
            <ul>
              <li className='mb-2 px-4'>
                ...
                <ul className="list-outside list-['—'] px-8">
                  <li className='mb-2 px-4'>
          ...
          <div className='my-2'>
            ...
            <ul>
              ...
              <li className='mb-2 px-4'>
                ...
                <ul className="list-outside list-['—'] px-8">
                  <li className='mb-2 px-4'>предоставлять Оператору достоверные данные о себе;</li>
                  <li className='mb-2 px-4'>
              ...
              <table className='min-w-full border border-gray-300'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='border border-gray-300 px-4 py-2'>
                      <ul>
                        <li className='mx-4 list-outside list-disc'>электронный адрес</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className='border border-gray-300 px-4 py-2'>
                      <ul>
                        <li className='mx-4 list-outside list-disc'>
                          <a
                            className='text-blue-600 hover:underline dark:text-blue-500'
                            href='http://www.kremlin.ru/acts/bank/24157'
                          >
          ...
          <div className='my-2'>
            ...
            <ul className='py-2'>
              ...
              <li className='px-4'>
                ...
                электронной почты Оператора <PrivacyMail /> с пометкой «Актуализация персональных
                данных».
              </li>
              <li className='px-4'>
            ...
            адрес Оператора <PrivacyMail /> с пометкой «Отзыв согласия на обработку персональных
            данных».
            <ul className='py-2'>
              <li className='px-4'>
          ...
          <div className='my-2'>
            ...
            <ul>
              ...
              <li className='mb-2 px-4'>
                ...
                адресу <LinkToSite link='https://mfl.maxbarsukov.ru/privacy' />.
              </li>
            </ul>
          </div>
