  ...
  return (
    ...
    <div className='flex flex-col w-full max-w-5xl mx-auto justify-center'>
      <div className='py-10'>
        ...
        <p className='my-2'>
          Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между владельцем <LinkToSite /> (далее <span className='font-bold'>MyFilmList</span> или Администрация) с одной стороны и пользователем сайта с другой.
        </p>
        <p className='my-2'>
          Сайт <span className='font-bold'>MyFilmList</span> не является средством массовой информации.
        </p>
        ...
        <div className="my-2">
          ...
          <ul className="mt-4 px-4 list-outside list-['—']">
        ...
        <div className="my-2">
          ...
          <div className='font-bold pt-4'>Администрация имеет право:</div>
          ...
          <div className='font-bold pt-4'>Пользователь обязуется:</div>
          ...
          <ul className="mt-4 px-4 list-outside list-['—']">
            ...
            <li className="mb-2 px-4">
              не танцевать брейк в переполненной маршрутке;
            </li>
            <li className="mb-2 px-4">
              не поджигать лисиц;
            </li>
            <li className="mb-2 px-4">
              не вербовать детей в Аль-Каиду;
            </li>
            <li className="mb-2 px-4">
              не играть в бадминтон головой крота;
            </li>
            <li className="mb-2 px-4">
              не выщипывает усы у усатых мужчин на улице;
            </li>
            <li className="mb-2 px-4">
              не разбавлять квас моторным маслом;
            </li>
            <li className="mb-2 px-4">
              не крестить иудеев;
            </li>
          ...
          <div className='font-bold pt-4'>Администрация обязуется:</div>
        ...
        <div className="my-2">
          ...
          <ul className="mt-4 px-4 list-outside list-['—']">
            ...
            <li className="mb-2 px-4">
              в случае нарушения Пользователем соглашения, пользователь обязуется отдать Администрации своего первенца в течении 30 рабочих дней с момента нарушения соглашения или рождения первенца;
            </li>
            <li className="mb-2 px-4">
